...
class IconPack : public QObject
{
    ...
    public slots:
        ...
        void apply_icons(const QString& name, bool hasfonts) const;           // calls apply script, which then runs original application and tells it to apply the icon theme
        bool apply_fonts(const QString& name, const QString& font_s) const;
        bool restart_homescreen() const;
        bool reinstall_icons() const;
        bool reinstall_fonts() const;
        ...
        bool restore(bool icons, bool fonts, const QString& type) const;      // calls restore script, which runs original application and restores original icon pack
        ...
        bool uninstall(const QString& packname, bool notify) const;
    ...
    signals:
        ...
        void iconsRestored();
        void fontsRestored();
        void restoreCompleted(QString type);
