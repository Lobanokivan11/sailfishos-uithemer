...
class IconPack : public QObject
{
    ...
    public slots:
        ...
        bool apply_icons(const QString& name, bool homescreen = false) const; // calls apply script, which then runs original application and tells it to apply the icon theme
